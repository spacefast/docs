...
- [REST API](/api) covers authentication, envelopes, and publish flows.
- [API keys](/account/api-keys) covers presets for automation.
- [CLI](/cli) covers `sf api` for ad-hoc signed requests.
