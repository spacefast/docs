...
[`@spacefast/vite-plugin`](/guides/frameworks/vite): it validates those
...
Or let [Git builds](/publish/git) detect the Astro project. Before upload,
...
[the Vite page](/guides/frameworks/vite).

## Redirect and header file conventions

See [Redirects](/serve/redirects) and [Headers](/serve/headers) for the file
syntax.
