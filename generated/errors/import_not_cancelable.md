...
description: "The import is past the point where it can be canceled."
---

The import is past the point where it can be canceled.
...
```json
{
  ...
  "status": 400,
  "detail": "The import is past the point where it can be canceled.",
