...
- [Zero](/zero) or [Functions](/functions) code, when the space runs a
  runtime.

Other things belong to the space rather than the version, and do not roll
back: [domains](/domains), [variables](/publish/variables),
[access Grants](/share), comment threads, and — for spaces that run code —
database rows and stored objects.
