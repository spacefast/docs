...
**How to resolve:** Use a domain you own; Spacefast default and management hostnames are assigned automatically.
...
```json
{
  "error": {
    ...
    "docsUrl": "https://spacefast.com/docs/errors/domain_reserved_suffix",
