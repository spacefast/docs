...
description: Documentation for image acceleration and delivery behavior on Spacefast.
---

Serve public images through Site Accelerator for CDN delivery and on-the-fly transforms. Resize, crop, filter, and compress by appending query parameters to a URL — no build step required.
...
- Site Accelerator is for image and static asset delivery. It does not serve video, audio, or other media formats as image transforms.
