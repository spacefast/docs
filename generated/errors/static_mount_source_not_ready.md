...
```json
{
  "type": "https://docs.spacefast.com/docs/errors/static_mount_source_not_ready",
  "title": "Static mount source not ready",
  "status": 400,
  "detail": "The website version that owns this mount is not ready.",
