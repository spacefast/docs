...
There are 612 error codes in the registry.
...
| [`policy_authority_revoked`](/errors/policy_authority_revoked) | The credential that asked for this access change no longer has permission to change this Space's access, so the change was not published. A publish freezes the access rules it declares, but the permission to apply them is re-checked at the moment they go live. |
