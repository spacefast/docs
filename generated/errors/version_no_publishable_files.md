...
```json
{
  "type": "https://docs.spacefast.com/docs/errors/version_no_publishable_files",
  "title": "Version no publishable files",
  "status": 400,
  "detail": "The version contains no publishable files.",
