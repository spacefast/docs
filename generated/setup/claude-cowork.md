...
One admin click adds the org connector, and every Cowork conversation can publish.
...
If nothing happens, add the endpoint in Claude Cowork yourself:
...
**Personal connector.** If you are not an org admin, add the connector to your own account. Cowork syncs your connectors at session start.
...
[Agent documentation](/agents) · [Claude's custom connector docs](https://claude.com/docs/connectors/custom/remote-mcp)
