...
`meta.title`, `meta.description`, and `meta.image` control generated listing, viewer, and social preview metadata. The same fields patch live with `sf spaces update`.
