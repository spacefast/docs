...
```json
{
  "type": "https://docs.spacefast.com/docs/errors/placement_invalid_burstable",
  "title": "Placement invalid burstable",
  "status": 400,
  "detail": "The placement burstable option was used with an unsupported placement mode.",
