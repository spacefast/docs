...
snapshot. See [Rollback](/publishing/rollback) for the CLI and dashboard workflow, or use
the [API reference](/api/reference) for the exact operation. Live and preview
pointers are [channels](/publishing/channels); promotion history lives there too.
