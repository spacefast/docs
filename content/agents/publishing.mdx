...
Claiming ends the space key's publish rights. When the owner explicitly enables
agent continuation during the claim, the key becomes a one-time exchange
voucher. The next publish with it fails with
