...
| Resource        | Events |
| --------------- | ------ |
| `space`         | `created`, `claimed`, `transferred`, `move_requested`, `moved`, `expired`, `disabled`, `enabled`, `deleted`, `config_updated`, `slug_updated`, `access_logout_all`, `access_transfer_scrub`, `share_link_created`, `share_link_revoked`, `access_request_created`, `access_request_resolved`, `grant_created`, `grant_updated`, `grant_revoked` |
...
| `team`          | `access_defaults_updated`, `updated`, `slug_updated`, `member_added`, `member_removed`, `member_role_updated`, `builds_deploys_quota_exceeded` |
...
| `user`          | `created`, `signed_in`, `deleted`, `impersonation_started`, `impersonation_stopped`, `two_factor_enabled`, `two_factor_disabled` |
